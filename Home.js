  ...
  return html`
    <div>
      ...
      <div className="relative w-full h-64 md:h-[440px] overflow-hidden mt-[64px]">
        ...
        <div className="absolute animate-float z-10 w-56 h-56 md:w-80 md:h-80" style=${{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
      ...
      <!-- ── Hero Text ── -->
      <section className="relative px-6 pb-20 mt-10 md:mt-14">
